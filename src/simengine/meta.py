# libs/simengine/src/simengine/meta.py
"""
...
class LogicMeta:
    ...
    # e.g., "simengine.core_data.ExecutionContext"
...
class CapabilityMeta:
    """描述一个由环境提供的内置能力 (Action/FoV/Rule)

    我们将其统一抽象为"能力"，以便上层服务统一处理。
    """
    name: str
    kind: str  # 'action', 'fov', 'rule'
    description: str
...
class EnvironmentMeta:
    ...
    display_name: str
    description: str
    class_path: str  # 用于动态实例化, e.g., "simengine.env.grid_world.GridWorldEnv"
